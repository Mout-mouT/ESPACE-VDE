...
public class uju {
    ...
    public void ajouterContact(Contact contact) {
        ...
        sauvegarderContacts(); // Enregistrer les contacts dans le fichier après l'ajout
    }
    ...
    public boolean modifierContact(String nom, String nouveauPrenom, String nouvelEmail, String nouveauTelephone) {
        ...
        if (contact != null) {
            ...
            sauvegarderContacts(); // Enregistrer les contacts dans le fichier après la modification
            return true;
        } else {
    ...
    public boolean supprimerContact(String nom) {
        ...
        if (contact != null) {
            ...
            sauvegarderContacts(); // Enregistrer les contacts dans le fichier après la suppression
            return true;
        } else {
            System.out.println("Contact non trouvé !");
            return false;
...
class Fcontact {
    ...
    public Fcontact(String nom, String prenom, String email, String telephone) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
